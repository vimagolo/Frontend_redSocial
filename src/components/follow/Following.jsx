...
export const Following = () => {
    ...
    const getUsers = async (pageNumber = 1) => {
        ...
        try {
            ...
            const request = await fetch(`${Global.url}follow/following/${userId}/${pageNumber}`, {
                method: "GET",
                headers: {
            ...
            if (data.status === "success") {
                const followigs = data.follows.docs.map(doc => doc.followed);
                console.log("followigs")
                console.log(followigs)
